...
tellraw @p "§3If the command has been executed, the above information can be ignored."
...
execute if score @e[tag=creator,limit=1] initial matches 0..0 run tellraw @p "§4Please assign 'initial' to a value other than 0 before running."