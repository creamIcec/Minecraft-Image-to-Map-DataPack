...
execute if score @e[tag=creator,limit=1] row matches 0..0 run tellraw @p {"text":"Note: you don't have to remove the armor_stand by yourself. As you are ready to generate another image, the armor_stand will be moved to your new location automatically.","color":"#5FFF98"}
...
scoreboard objectives remove runsuccess