...
execute if score @e[tag=creator,limit=1] line matches 2..100 run function loop:refreshlineremove
execute if score @e[tag=creator,limit=1] line matches 1..1 run function loop:refreshrowremove